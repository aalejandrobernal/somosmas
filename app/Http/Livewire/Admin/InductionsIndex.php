...
class InductionsIndex extends Component
{
    use WithFileUploads;
    public $imagen;
    public $cuerpo;
    ...
    {
        $forms = 
        Induccion::where('estado',$this->estado)
        ->orderBy('orden', 'asc')
        ->get();
        return view('livewire.admin.inductions-index',compact('forms'));
    }
    public function create()
    {
        ...
        Storage::disk('local')->put('public/images/inducciones' . '/' . $avatarName, $img, 'public');
    ...
    public function deshabilitar(Induccion $banner)
    {
