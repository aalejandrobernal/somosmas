...
class EditInductionsIndex extends Component
{
    use WithFileUploads;
    public $imagen;
    public $form;
    ...
    public function mount(Induccion $form)
    {

        $this->form = $form;

        $this->orden = Induccion::where('estado',1)
        ->orderBy('orden', 'asc')
        ->get();
    }
    public function render()
    {
        return view('livewire.admin.edit-inductions-index');
    }
    public function update()
    {
        ...
        if($this->form->orden!=Induccion::whereId($this->form->id)->value('orden'))
        {
