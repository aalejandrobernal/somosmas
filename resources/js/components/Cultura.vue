        ...
        <div class="container text-center aling-items-center">
            <div class="row aling-items-center">
                <div class="col-6 offset-3">
                    <h1 class="titulo">Fechas Especiales</h1>
                    <hr class="line-title">
                </div>
                    ...
                    <div class="col-6 hola fondo1  ">
                        ...
                        <ul class="list-group">
                            <li id="list-item-active" class="list-group-item active"><i class="fa-solid fa-circle-check"></i> Presidente: Juan M. Sanchez
                                – Sunco Energy</li>
                            <li id="list-item-1" class="list-group-item"><i class="fa-solid fa-circle-check"></i> Secretaria: Catalina
                            ...
                            <li id="list-item-active" class="list-group-item active"><i  class="fa-solid fa-circle-check"></i> Promotor: Ivon Romero –
                                Liwa</li>
                            <li id="list-item-1" class="list-group-item"><i class="fa-solid fa-circle-check"></i> Contenidos: Irana Carrión –
                                Suncolombia</li>
                            <li id="list-item-active" class="list-group-item active"><i class="fa-solid fa-circle-check"></i> Integrante: Liliana Ravelo
                                – Suncolombia</li>
                            <li id="list-item-1" class="list-group-item"><i class="fa-solid fa-circle-check"></i> Integrante: Juan Diego
                            ...
                            <li id="list-item-1" class="list-group-item"><i class="fa-solid fa-circle-check"></i> Integrante: Iván Diaz -
                                Suncolombia</li>
                        </ul>
                        <br>
                ...
                <div class="row aling items center">
                        ...
                        <article class="card h-100">
                            <div class="card-body visible">
                                <div class="d-flex mb-3">
                                    <img src="/images/Jhon.jpg" alt="" class="foto-video">
                    ...
                    <div class="col-6 p-3">
                        <article class="card h-100">
                            <div class="card-body visible">
                                <div class="d-flex mb-3">
                                    <img src="/images/carlos.jpg" alt="" class="foto-video">
                                    <div class="datos pt-2">
                    ...
                    <div class="col-6 p-3">
                        <article class="card h-100">
                            <div class="card-body visible">
                                <div class="d-flex mb-3">
                                    <img src="/images/ximena.jpg" alt="" class="foto-video">
                                    <div class="datos pt-2">
                    ...
                    <div class="col-6 p-3">
                        <article class="card h-100">
                            <div class="card-body visible">
                                <div class="d-flex mb-3">
                                    <img src="/images/paula.jpeg" alt="" class="foto-video">
                                    <div class="datos pt-2">
                    ...
                    <div class="col-6 p-3">
                        <article class="card h-100">
                            <div class="card-body visible">
                                <div class="d-flex mb-3">
                                    <img src="/images/vanesa.jpg" alt="" class="foto-video">
                                    <div class="datos pt-2">
                    ...
                    <div class="col-6 p-3">
                        <article class="card h-100">
                            <div class="card-body visible">
                                <div class="d-flex mb-3">
                                    <img src="/images/anamaria.jpg" alt="" class="foto-video">
                                    <div class="datos">
            ...
            <section id="galleryy">
                <div class="carrusel1">
                    <div class="carrusel-items1">
                        ...
                        <div class="carrusel-item">
                            <img src="/images/galeria/7.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/8.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/9.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/10.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                        ...
                        <div class="carrusel-item">
                            <img src="/images/galeria/15.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/16.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/17.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/18.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/19.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/20.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/21.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/22.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/23.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/24.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/25.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/26.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/27.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/28.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/29.jpg" alt="">
                        </div>
                        <div class="carrusel-item">
                            <img src="/images/galeria/30.jpg" alt="">
                        </div>
                    </div>
                </div>
            </section>
