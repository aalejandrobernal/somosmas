    ...
    <div>
        ...
        <main class="container d-flex justify-content-center align-items-center p-5 pr-10">
            <div class="col-12">
                ...
                <div class="row">
                    <!-- {{--formaciones Comites --}} -->
                    <section id="" class="d-flex justify-content-center align-items-center p-2">
                        <div class="row">
                            ...
                            <div class="comites row">
                                <div class="col-3 p-2">
                                    <div class="card">
                                        <img src="images/copasst.png" class="card-img-top" alt="...">
                                        <div class="card-body">
                                ...
                                <div class="col-3 p-2">
                                    <div class="card" style="border-color: #FE3EB2">
                                        <img src="images/ambiental.jpg" class="card-img-top" alt="...">
                                        <div class="card-body">
