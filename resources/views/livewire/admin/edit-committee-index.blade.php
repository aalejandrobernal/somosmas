            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Editar comité {{ $form->titulo }}</h5>
                        ...
                        <div class="modal-body">
                                ...
                                {{-- <div class=" justify-content-center "> --}}
                                    {{-- <div style="height: 150px; background-color: rgba(255,0,0,0.1);"> --}}
                                         <div class="h-50 d-inline-block" style="width: 300px;"> 
                                            @if (!$imagen)
                                            <img class="mw-100" src="../storage/images/inducciones/{{ $form->imagen }}" alt="">
                                            @else
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-8">
                                    ...
                                    {!! Form::text('titulo' . $form->id, $form->titulo, ['class' => 'form-control','wire:model'=>'form.titulo','maxlength'=>'70']) !!}
